...
const EditarProyecto = () => {
    ...
    return (
        <>
            ...
            <h1 className="font-black text-4xl text-white">Editar Proyecto : {nombre}</h1>
                <div className="flex items-center gap-2 text-gray-400 hover:text-white">
                    ...
                    <button type="button" className=" uppercase font-bolt text-white" onClick={handleClikEliminar}>Eliminar</button>
